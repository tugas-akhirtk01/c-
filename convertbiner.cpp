...
int main()
 ...
 {    
   ...
   int i;    
   cout << "------------------------------------------\n";    
   cout << "Selamat Datang di Aplikasi Konversi Biner \n";
   ...
   do {        
       ...
       if (username ==user && password == pass) {            
           ...
           cout << "\n\n";            
           cout << "Maaf Username atau Password Salah!" << endl;                         
       cout << "\n\n";            
           i = i +1;       
       }   
    }while (i <= 3);       
    if(login != 1){
       cout<<"Anda Telah 3x Memasukan Username atau Password Yang Salah\n";       
 ...
 switch(pilihan){
  ...
  break;
  case 3:
   cout << "Terima Kasih Anda Telah Berhasil Keluar";
   exit(1);
